...
const PublicProfileHistoryTab = ({ userId, username }: PublicProfileHistoryTabProps) => {
  ...
  const fetchInteractions = useCallback(async (offsetValue = 0, append = false) => {
    ...
    try {
      ...
      try {
        // Get user interactions - using public endpoint
      ...
      <div className="bg-white shadow rounded-lg overflow-hidden">
        <div className="p-6">
          <div className="flex justify-center items-center py-12">
            ...
            <span className="text-gray-600">Loading rating history...</span>
          </div>
        </div>
      </div>
    );
    ...
    return (
      <div className="bg-white shadow rounded-lg overflow-hidden">
        <div className="p-6 text-center">
          ...
          <h3 className="text-lg font-medium text-gray-900">No Public Ratings Yet</h3>
    ...
    <div className="bg-white shadow rounded-lg overflow-hidden">
      <div className="px-6 py-4 bg-primary-50 border-b border-primary-100">
        <h3 className="text-lg font-medium text-primary-800 flex items-center">
          ...
          {username ? `${username}'s` : "User's"} Rating History
        </h3>
      </div>
        ...
        <div className="mb-6 flex justify-between items-center">
          <div className="flex items-center">
            ...
            <span className="text-gray-700">
              {totalCount} {totalCount === 1 ? 'public entry' : 'public entries'}
            </span>
          </div>
