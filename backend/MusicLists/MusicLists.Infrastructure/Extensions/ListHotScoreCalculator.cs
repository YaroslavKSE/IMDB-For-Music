...
public class ListHotScoreCalculator
{
    ...
    public ListHotScoreCalculator()
    { }

    // Constructor with custom weight values
    public ListHotScoreCalculator(float likeWeight, float commentWeight, float timeConstant, float gravity, int maxAgeDays)
    {
